...
local UIElements = {
    ...
    TabUIStroke = nil,
    ItemUIStroke = nil,
    HighlightUIStroke = nil,
    ToggleOuterUIStroke = nil,
    ToggleOuterUIStrokeEnabled = nil,

    -- Sliders and Toggles
    SliderOuter = nil,
    SliderInner = nil,
    ToggleOuter = nil,
    ToggleOuterEnabled = nil,
    ToggleInner = nil,
    ToggleInnerEnabled = nil,
    ...
    -- Misc
    MainUIStrokeSelected = nil
}

local Themes = {
    ["Dark"] = {
        Topbar = Color3.fromRGB(35, 35, 40),
        TabContainer = Color3.fromRGB(28, 28, 33),
        Lines = Color3.fromRGB(55, 55, 60),
        HoverTabFrame = Color3.fromRGB(58, 58, 62),
        ItemUIStroke = Color3.fromRGB(45, 45, 54),
        TabFrame = Color3.fromRGB(40, 40, 45),
        SectionFrame = Color3.fromRGB(35, 35, 40),
        TabText = Color3.fromRGB(245, 245, 245),
        ItemText = Color3.fromRGB(245, 245, 245),
        ItemUIStrokeSelected = Color3.fromRGB(86, 207, 212),
        DropdownIcon = Color3.fromRGB(180, 180, 180),
        SectionText = Color3.fromRGB(245, 245, 245),
        SelectedTabFrame = Color3.fromRGB(70, 70, 75),
        ItemFrame = Color3.fromRGB(40, 40, 45),
        HoverItemFrame = Color3.fromRGB(58, 58, 62),
        SectionUIStroke = Color3.fromRGB(42, 42, 49),
        MainUIStroke = Color3.fromRGB(59, 59, 68),
        Main = Color3.fromRGB(25, 25, 30),
        Shadow = Color3.fromRGB(25, 25, 30),
        TabUIStroke = Color3.fromRGB(44, 44, 52),
        SliderOuter = Color3.fromRGB(65, 65, 75),
        SliderInner = Color3.fromRGB(86, 207, 212),
        ToggleOuter = Color3.fromRGB(40, 40, 45),
        InputPlaceHolder = Color3.fromRGB(65, 65, 70),
        ToggleOuterEnabled = Color3.fromRGB(58, 58, 66),
        ToggleOuterUIStroke = Color3.fromRGB(59, 59, 67),
        ToggleOuterUIStrokeEnabled = Color3.fromRGB(72, 72, 82),
        ToggleInner = Color3.fromRGB(71, 71, 81),
        ToggleInnerEnabled = Color3.fromRGB(86, 207, 212),
        ContainerHolder = Color3.fromRGB(31, 31, 36),
        HighlightUIStroke = Color3.fromRGB(84, 84, 91),
        Highlight = Color3.fromRGB(86, 207, 212)
    },
    ["ElixirClient"] = {
        Topbar = Color3.fromRGB(1, 1, 1),
        ...
        ItemUIStrokeSelected = Color3.fromRGB(38, 69, 169),
        DropdownIcon = Color3.fromRGB(175, 175, 175),
        SectionText = Color3.fromRGB(237, 237, 237),
        SelectedTabFrame = Color3.fromRGB(178, 64, 210),
        ...
        SliderInner = Color3.fromRGB(178, 64, 210),
        ...
        ToggleInnerEnabled = Color3.fromRGB(178, 64, 210),
        ContainerHolder = Color3.fromRGB(26, 26, 31),
        HighlightUIStroke = Color3.fromRGB(79, 79, 86),
        Highlight = Color3.fromRGB(237, 237, 237)
    },
    ["Tokyo Night"] = {
    ...
    ["Ocean"] = {
        Topbar = Color3.fromRGB(22, 36, 47),
        TabContainer = Color3.fromRGB(18, 30, 39),
        Lines = Color3.fromRGB(39, 62, 80),
        HoverTabFrame = Color3.fromRGB(35, 56, 73),
        ItemUIStroke = Color3.fromRGB(31, 50, 65),
        TabFrame = Color3.fromRGB(27, 44, 58),
        SectionFrame = Color3.fromRGB(22, 36, 47),
        TabText = Color3.fromRGB(240, 245, 255),
        ItemText = Color3.fromRGB(240, 245, 255),
        ItemUIStrokeSelected = Color3.fromRGB(65, 185, 255),
        DropdownIcon = Color3.fromRGB(180, 190, 200),
        SectionText = Color3.fromRGB(240, 245, 255),
        SelectedTabFrame = Color3.fromRGB(41, 67, 87),
        ItemFrame = Color3.fromRGB(27, 44, 58),
        HoverItemFrame = Color3.fromRGB(35, 56, 73),
        SectionUIStroke = Color3.fromRGB(28, 46, 60),
        MainUIStroke = Color3.fromRGB(45, 73, 95),
        Main = Color3.fromRGB(16, 26, 34),
        Shadow = Color3.fromRGB(16, 26, 34),
        TabUIStroke = Color3.fromRGB(33, 54, 70),
        SliderOuter = Color3.fromRGB(39, 62, 80),
        SliderInner = Color3.fromRGB(65, 185, 255),
        ToggleOuter = Color3.fromRGB(27, 44, 58),
        InputPlaceHolder = Color3.fromRGB(45, 73, 95),
        ToggleOuterEnabled = Color3.fromRGB(35, 56, 73),
        ToggleOuterUIStroke = Color3.fromRGB(31, 50, 65),
        ToggleOuterUIStrokeEnabled = Color3.fromRGB(65, 185, 255),
        ToggleInner = Color3.fromRGB(39, 62, 80),
        ToggleInnerEnabled = Color3.fromRGB(65, 185, 255),
        ContainerHolder = Color3.fromRGB(20, 32, 42),
        HighlightUIStroke = Color3.fromRGB(52, 84, 109),
        Highlight = Color3.fromRGB(65, 185, 255)
    },

    ["Forest"] = {
        Topbar = Color3.fromRGB(27, 35, 25),
        TabContainer = Color3.fromRGB(22, 29, 20),
        Lines = Color3.fromRGB(48, 62, 45),
        HoverTabFrame = Color3.fromRGB(43, 56, 40),
        ItemUIStroke = Color3.fromRGB(38, 50, 36),
        TabFrame = Color3.fromRGB(33, 44, 31),
        SectionFrame = Color3.fromRGB(27, 35, 25),
        TabText = Color3.fromRGB(245, 250, 240),
        ItemText = Color3.fromRGB(245, 250, 240),
        ItemUIStrokeSelected = Color3.fromRGB(106, 192, 89),
        DropdownIcon = Color3.fromRGB(190, 200, 185),
        SectionText = Color3.fromRGB(245, 250, 240),
        SelectedTabFrame = Color3.fromRGB(51, 67, 48),
        ItemFrame = Color3.fromRGB(33, 44, 31),
        HoverItemFrame = Color3.fromRGB(43, 56, 40),
        SectionUIStroke = Color3.fromRGB(35, 46, 33),
        MainUIStroke = Color3.fromRGB(56, 73, 53),
        Main = Color3.fromRGB(20, 26, 19),
        Shadow = Color3.fromRGB(20, 26, 19),
        TabUIStroke = Color3.fromRGB(41, 54, 38),
        SliderOuter = Color3.fromRGB(48, 62, 45),
        SliderInner = Color3.fromRGB(106, 192, 89),
        ToggleOuter = Color3.fromRGB(33, 44, 31),
        InputPlaceHolder = Color3.fromRGB(56, 73, 53),
        ToggleOuterEnabled = Color3.fromRGB(43, 56, 40),
        ToggleOuterUIStroke = Color3.fromRGB(38, 50, 36),
        ToggleOuterUIStrokeEnabled = Color3.fromRGB(106, 192, 89),
        ToggleInner = Color3.fromRGB(48, 62, 45),
        ToggleInnerEnabled = Color3.fromRGB(106, 192, 89),
        ContainerHolder = Color3.fromRGB(24, 32, 23),
        HighlightUIStroke = Color3.fromRGB(64, 84, 60),
        Highlight = Color3.fromRGB(106, 192, 89)
    },

    ["Sunset"] = {
        Topbar = Color3.fromRGB(41, 28, 45),
        TabContainer = Color3.fromRGB(34, 23, 37),
        Lines = Color3.fromRGB(71, 49, 78),
        HoverTabFrame = Color3.fromRGB(64, 44, 70),
        ItemUIStroke = Color3.fromRGB(57, 39, 63),
        TabFrame = Color3.fromRGB(50, 34, 55),
        SectionFrame = Color3.fromRGB(41, 28, 45),
        TabText = Color3.fromRGB(255, 240, 245),
        ItemText = Color3.fromRGB(255, 240, 245),
        ItemUIStrokeSelected = Color3.fromRGB(255, 156, 89),
        DropdownIcon = Color3.fromRGB(200, 185, 190),
        SectionText = Color3.fromRGB(255, 240, 245),
        SelectedTabFrame = Color3.fromRGB(76, 53, 84),
        ItemFrame = Color3.fromRGB(50, 34, 55),
        HoverItemFrame = Color3.fromRGB(64, 44, 70),
        SectionUIStroke = Color3.fromRGB(52, 36, 57),
        MainUIStroke = Color3.fromRGB(84, 58, 92),
        Main = Color3.fromRGB(30, 21, 33),
        Shadow = Color3.fromRGB(30, 21, 33),
        TabUIStroke = Color3.fromRGB(61, 42, 67),
        SliderOuter = Color3.fromRGB(71, 49, 78),
        SliderInner = Color3.fromRGB(255, 156, 89),
        ToggleOuter = Color3.fromRGB(50, 34, 55),
        InputPlaceHolder = Color3.fromRGB(84, 58, 92),
        ToggleOuterEnabled = Color3.fromRGB(64, 44, 70),
        ToggleOuterUIStroke = Color3.fromRGB(57, 39, 63),
        ToggleOuterUIStrokeEnabled = Color3.fromRGB(255, 156, 89),
        ToggleInner = Color3.fromRGB(71, 49, 78),
        ToggleInnerEnabled = Color3.fromRGB(255, 156, 89),
        ContainerHolder = Color3.fromRGB(36, 25, 40),
        HighlightUIStroke = Color3.fromRGB(96, 66, 105),
        Highlight = Color3.fromRGB(255, 156, 89)
    }
}

library.selectedTheme = Themes[library.Theme]
...
function library:ApplyTheme(themeName)
    ...
    for elementName, element in pairs(UIElements) do
        if element and self.selectedTheme[elementName] then
            if element:IsA("GuiObject") then
                element.BackgroundColor3 = self.selectedTheme[elementName]
            end
    
            if element:IsA("ImageLabel") or element:IsA("ImageButton") then
                element.ImageColor3 = self.selectedTheme[elementName]
            end
    
            if element:IsA("TextLabel") or element:IsA("TextButton") then
                element.TextColor3 = self.selectedTheme[elementName]
            end

            if element:IsA("UIStroke") then
                element.Color = self.selectedTheme[elementName]
            end
        else
            warn("No matching UI element or color for: " .. elementName)
        end
    end
...
notificationMain.BackgroundColor3 = Themes[library.Theme].Topbar
...
local menta = Instance.new("ScreenGui")
menta.Name = HttpService:GenerateGUID(true)
menta.ZIndexBehavior = Enum.ZIndexBehavior.Global
menta.Parent = GuiFolder
...
mainShadow.Image = getcustomasset("MentaLib/Shadow.png")
...
minimizeButton.MouseEnter:Connect(function()
    TweenService:Create(minimizeButton, TweenInfo.new(.125, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {ImageColor3 = library.selectedTheme.Highlight}):Play()
end)
...
UIElements.MainUIStroke = uIStroke
...
Info.Icon = Info.Icon or "rbxassetid://12345678"
...
UIElements.TabText = tabName

tabFrame.MouseEnter:Connect(function()
    if SelectedTab == nil or SelectedTab ~= tab then
        TweenService:Create(tabFrame, TweenInfo.new(.125, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {BackgroundColor3 = library.selectedTheme.HoverTabFrame}):Play()
...
tabFrame.MouseLeave:Connect(function()
    if SelectedTab == nil or SelectedTab ~= tab then
        TweenService:Create(tabFrame, TweenInfo.new(.125, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {BackgroundColor3 = library.selectedTheme.TabFrame}):Play()
...
UIElements.SectionFrame = sectionFrame
...
sectionName.Size = UDim2.new(1, 0, 0, 28)
sectionName.Parent = sectionFrame
sectionName.ZIndex = Sections + 2
UIElements.SectionText = sectionName
...
containerHolder.Size = UDim2.new(1, 0, 0.9, 0)
containerHolder.Parent = sectionFrame
UIElements.ContainerHolder = containerHolder
...
UIElements.ContainerHolder = itemContainer
...
local function updateSectionSize()
    local contentHeight = itemUIListLayout.AbsoluteContentSize.Y
    containerHolder.Size = UDim2.new(1, 0, 0, contentHeight)
    sectionFrame.Size = UDim2.new(1, 0, 0, 28 + contentHeight)
    section.Size = UDim2.new(1, 0, 0, 33 + contentHeight)
end
...
keybind.Size = UDim2.new(.9, 0, 0, 28)
...
keybindFrame.Size = UDim2.new(.9, 0, 0, 24)
keybindFrame.Parent = keybind
UIElements.ItemFrame = keybindFrame
...
UIElements.ItemText = keybindText
...
keybindTextButton.Size = UDim2.new(1, 0, 0, 24)
...
UIElements.ItemUIStroke = keybindUIStroke
...
keybindOuter.Position = UDim2.new(0.5, 139, 0.125, 2)
keybindOuter.Size = UDim2.new(0, 30, 0, 14)
keybindOuter.Parent = keybindFrame
UIElements.ToggleOuter = keybindOuter
...
UIElements.ToggleOuterUIStroke = keybindOuterUIStroke
...
keybindFrame.MouseEnter:Connect(function()
    TweenService:Create(keybindFrame, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {BackgroundColor3 = library.selectedTheme.HoverItemFrame}):Play()
end)

keybindFrame.MouseLeave:Connect(function()
    TweenService:Create(keybindFrame, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {BackgroundColor3 = library.selectedTheme.ItemFrame}):Play()
end)
...
keybindTextButton.MouseButton1Click:Connect(function()
    ...
    keybindOuterUIStroke.Color = library.selectedTheme.ItemUIStrokeSelected
    KeybindConnection = UserInputService.InputBegan:Connect(function(Key, gameProcessed)
        if not table.find(Blacklist, Key.KeyCode) and not gameProcessed then
            ...
            keybindOuterUIStroke.Color = library.selectedTheme.ToggleOuterUIStroke
...
slider.Size = UDim2.new(.9, 0, 0, 36)
...
sliderFrame.Position = UDim2.new(.5, 0, .5, 0)
sliderFrame.Size = UDim2.new(.9, 0, 0, 32)
sliderFrame.Parent = slider
UIElements.ItemFrame = sliderFrame
...
sliderText.Size = UDim2.new(1, 0, 0, 24)
sliderText.Parent = sliderFrame
UIElements.ItemText = sliderText
...
UIElements.ItemUIStroke = sliderUIStroke
...
sliderValueText.Position = UDim2.new(0.095, 0, 0, 0)
sliderValueText.Size = UDim2.new(.9, 0, 0, 24)
sliderValueText.Parent = sliderFrame
UIElements.ItemText = sliderValueText
...
sliderOuter.Size = UDim2.new(0.97, 0, 0, 5)
sliderOuter.Parent = sliderFrame
UIElements.SliderOuter = sliderOuter
...
UIElements.SliderInner = sliderInner
...
dragIcon.Image = getcustomasset("MentaLib/Circle.png")
...
dragButton.MouseButton1Down:Connect(function()
    ...
    MouseMove = UserInputService.InputChanged:Connect(function(input)
        if input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch then
            if sliderActive and sliderOuter.Visible then
                local Px = library:GetXY(sliderOuter)
                local SizeFromScale = math.clamp((MinSize + (MaxSize - MinSize)) * Px, 0, 1)
                local Value = math.floor(Info.Minimum + ((Info.Maximum - Info.Minimum) * Px))

                TweenService:Create(sliderInner, TweenInfo.new(0.09, Enum.EasingStyle.Linear, Enum.EasingDirection.Out), {Size = UDim2.new(SizeFromScale, 0, 0, 5)}):Play()
...
inputFrame.Size = UDim2.new(.9, 0, 0, 24)
inputFrame.Parent = input
UIElements.ItemFrame = inputFrame
...
UIElements.ItemUIStroke = inputUIStroke
...
UIElements.InputPlaceHolder = textBox
UIElements.ItemText = textBox

inputFrame.MouseEnter:Connect(function()
    TweenService:Create(inputFrame, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {BackgroundColor3 = library.selectedTheme.HoverItemFrame}):Play()
end)

inputFrame.MouseLeave:Connect(function()
    TweenService:Create(inputFrame, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {BackgroundColor3 = library.selectedTheme.ItemFrame}):Play()
end)

textBox.Focused:Connect(function()
    TweenService:Create(inputUIStroke, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {Color = library.selectedTheme.ItemUIStrokeSelected}):Play()
end)

textBox.FocusLost:Connect(function()
    TweenService:Create(inputUIStroke, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {Color = library.selectedTheme.ItemUIStroke}):Play()
...
dropdown.Size = UDim2.new(.9, 0, 0, 28)
...
dropdownFrame.Position = UDim2.new(.5, 0, .5, 0)
dropdownFrame.Size = UDim2.new(.9, 0, 0, 24)
dropdownFrame.Parent = dropdown
UIElements.ItemFrame = dropdownFrame
...
dropdownText.Size = UDim2.new(1, 0, 0, 24)
dropdownText.Parent = dropdownFrame
UIElements.ItemText = dropdownText
...
dropdownTextButton.Size = UDim2.new(1, 0, 0, 24)
...
dropdownFrame.MouseEnter:Connect(function()
    TweenService:Create(dropdownFrame, TweenInfo.new(.125, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {BackgroundColor3 = library.selectedTheme.HoverItemFrame}):Play()
end)

dropdownFrame.MouseLeave:Connect(function()
    TweenService:Create(dropdownFrame, TweenInfo.new(.125, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {BackgroundColor3 = library.selectedTheme.ItemFrame}):Play()
    TweenService:Create(dropdownUIStroke, TweenInfo.new(.125, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {Color = library.selectedTheme.ItemUIStroke}):Play()
end)

dropdownTextButton.MouseButton1Down:Connect(function()
    TweenService:Create(dropdownUIStroke, TweenInfo.new(.125, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {Color = library.selectedTheme.ItemUIStrokeSelected}):Play()
end)
...
if DropdownOpened then
    TweenService:Create(dropdownContainer, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out), {
        Size = UDim2.new(1, 0, 0, DropdownY)
    }):Play()
end
...
dropdownElement.Size = UDim2.new(1, 0, 0, 24)
...
dropdownElementText.Position = UDim2.new(0, 25, 0, 0)
dropdownElementText.Size = UDim2.new(1, 0, 0, 24)
dropdownElementText.Parent = dropdownElement
UIElements.ItemText = dropdownElementText
...
dropdownElementButton.Size = UDim2.new(1, 0, 0, 24)
dropdownElementButton.Parent = dropdownElement

dropdownElement.MouseEnter:Connect(function()
    TweenService:Create(dropdownElementText, TweenInfo.new(.125, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {TextColor3 = library.selectedTheme.Highlight}):Play()
end)

dropdownElement.MouseLeave:Connect(function()
    TweenService:Create(dropdownElementText, TweenInfo.new(.125, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {TextColor3 = library.selectedTheme.ItemText}):Play()
end)
...
dropdownElementButton.MouseButton1Click:Connect(function()
    ...
    TweenService:Create(dropdownFrame, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {BackgroundColor3 = library.selectedTheme.ItemFrame}):Play()
    TweenService:Create(dropdownUIStroke, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {Color = library.selectedTheme.ItemUIStroke}):Play()
    ...
    TweenService:Create(dropdown, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out), {Size = DropdownOpened and UDim2.new(.9, 0, 0, DropdownY + 28) or UDim2.new(.9, 0, 0, 28)}):Play()
    TweenService:Create(dropdownFrame, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out), {Size = DropdownOpened and UDim2.new(.9, 0, 0, DropdownY + 24) or UDim2.new(.9, 0, 0, 24)}):Play()
    TweenService:Create(dropdownContainer, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out), {Size = DropdownOpened and UDim2.new(1, 0, 0, DropdownY) or UDim2.new(1, 0, 0, 0)}):Play()
    ...
    dropdownIcon.Position = DropdownOpened and UDim2.new(0, 288, 0, 5) or UDim2.new(0, 288, 0, 5)
...
function insidedropdown:Remove(opt)
    for _,v in pairs(dropdownContainer:GetChildren()) do
        if v.ClassName == "Frame" and v.dropdownElementText.Text == opt then
            DropdownY = DropdownY - 24
            if DropdownOpened then
                TweenService:Create(dropdownFrame, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out), {Size = UDim2.new(.9, 0, 0, dropdownFrame.Size.Y.Offset - 24)}):Play()
                TweenService:Create(dropdownContainer, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out), {Size = UDim2.new(1, 0, 0, dropdownContainer.Size.Y.Offset - 24)}):Play()
                task.wait(.1)
            end
            v:Destroy()
        end
...
local function updateSectionOnDrop()
    local dropdownHeight = DropdownOpened and dropdownUIListLayout.AbsoluteContentSize.Y or 0
    local totalContentHeight = itemUIListLayout.AbsoluteContentSize.Y + dropdownHeight

    dropdownContainer.Size = UDim2.new(1, 0, 0, dropdownHeight)
    containerHolder.Size = UDim2.new(1, 0, 0, totalContentHeight)
    sectionFrame.Size = UDim2.new(1, 0, 0, 28 + totalContentHeight)
    section.Size = UDim2.new(1, 0, 0, sectionFrame.Size.Y.Offset)
end
...
dropdownUIListLayout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(updateSectionOnDrop)
itemUIListLayout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(updateSectionOnDrop)
...
toggleFrame.Size = UDim2.new(.9, 0, 0, 24)
toggleFrame.Parent = toggle
UIElements.ItemFrame = toggleFrame
...
toggleText.Size = UDim2.new(.9, 0, 0, 24)
toggleText.Parent = toggleFrame
UIElements.ItemText = toggleText
...
toggleTextButton.Size = UDim2.new(1, 0, 0, 24)
...
UIElements.ItemUIStroke = toggleUIStroke

toggleFrame.MouseEnter:Connect(function()
    TweenService:Create(toggleFrame, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {BackgroundColor3 = library.selectedTheme.HoverItemFrame}):Play()
end)

toggleFrame.MouseLeave:Connect(function()
    TweenService:Create(toggleFrame, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {BackgroundColor3 = library.selectedTheme.ItemFrame}):Play()
    TweenService:Create(toggleUIStroke, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {Color = library.selectedTheme.ItemUIStroke}):Play()
end)

toggleTextButton.MouseButton1Down:Connect(function()
    TweenService:Create(toggleUIStroke, TweenInfo.new(.13, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {Color = library.selectedTheme.ItemUIStrokeSelected}):Play()
end)

toggleTextButton.MouseButton1Up:Connect(function()
    TweenService:Create(toggleUIStroke, TweenInfo.new(.13, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {Color = library.selectedTheme.ItemUIStroke}):Play()
end)

local toggleOuter = Instance.new("Frame")
toggleOuter.Name = "ToggleOuter"
toggleOuter.BackgroundColor3 = Theme.ToggleOuter
toggleOuter.Position = UDim2.new(.4, 139, 0.167, 1)
toggleOuter.Size = UDim2.new(0, 30, 0, 14)
toggleOuter.Parent = toggleFrame
UIElements.ToggleOuter = toggleOuter
...
UIElements.ToggleOuterUIStroke = toggleOuterUIStroke
...
toggleInner.Image = getcustomasset("MentaLib/Circle.png")
...
UIElements.ToggleInner = toggleInner
...
TweenService:Create(toggleOuter, TweenInfo.new(.125, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {BackgroundColor3 = bool and library.selectedTheme.ToggleOuterEnabled or library.selectedTheme.ToggleOuter}):Play()
TweenService:Create(toggleInner, TweenInfo.new(.125, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {ImageColor3 = bool and library.selectedTheme.ToggleInnerEnabled or library.selectedTheme.ToggleInner}):Play()
...
TweenService:Create(toggleOuterUIStroke, TweenInfo.new(.125, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {Color = bool and library.selectedTheme.ToggleOuterUIStrokeEnabled or library.selectedTheme.ToggleOuterUIStroke}):Play()
...
button.Size = UDim2.new(.9, 0, 0, 28)
...
buttonFrame.Size = UDim2.new(.9, 0, 0, 24)
buttonFrame.Parent = button
UIElements.ItemFrame = buttonFrame
...
UIElements.ItemUIStroke = buttonUIStroke

buttonFrame.MouseEnter:Connect(function()
    TweenService:Create(buttonFrame, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {BackgroundColor3 = library.selectedTheme.HoverItemFrame}):Play()
end)

buttonFrame.MouseLeave:Connect(function()
    TweenService:Create(buttonFrame, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {BackgroundColor3 = library.selectedTheme.ItemFrame}):Play()
    TweenService:Create(buttonUIStroke, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {Color = library.selectedTheme.ItemUIStroke}):Play()
end)
...
buttonText.Size = UDim2.new(1, 0, 0, 24)
buttonText.Parent = buttonFrame
UIElements.ItemText = buttonText
...
buttonTextButton.Size = UDim2.new(1, 0, 0, 24)
buttonTextButton.Parent = buttonFrame

buttonTextButton.MouseButton1Down:Connect(function()
    TweenService:Create(buttonUIStroke, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {Color = library.selectedTheme.ItemUIStrokeSelected}):Play()
end)
...
function sectiontable:Label(Info)
    ...
    Info.Size = Info.Size or UDim2.new(.9, 0, 0, 24)
    ...
    labelFrame.BackgroundColor3 = library.selectedTheme.ItemFrame
    labelFrame.BorderSizePixel = 0
    labelFrame.Position = UDim2.new(0.5, 0, 0.5, 0)
    labelFrame.Size = Info.Size
    labelFrame.Parent = label
    UIElements.ItemFrame = labelFrame

    local labelText = Instance.new("TextLabel")
    labelText.Name = "LabelText"
    labelText.Font = Enum.Font.GothamBold
    labelText.Text = Info.Text
    labelText.TextColor3 = library.selectedTheme.ItemText
    labelText.TextSize = 12
    labelText.TextXAlignment = Enum.TextXAlignment.Left
    labelText.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    labelText.BackgroundTransparency = 1
    labelText.Size = UDim2.new(1, 0, 0, 24)
    labelText.Position = UDim2.new(0, 7, 0, 0)
    labelText.Parent = labelFrame
    UIElements.ItemText = labelText

    local labelUIStroke = Instance.new("UIStroke")
    labelUIStroke.Name = "LabelUIStroke"
    labelUIStroke.Color = library.selectedTheme.ItemUIStroke
    labelUIStroke.Parent = labelFrame
    UIElements.ItemUIStroke = labelUIStroke

    labelFrame.MouseEnter:Connect(function()
        TweenService:Create(labelFrame, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {BackgroundColor3 = library.selectedTheme.HoverItemFrame}):Play()
    end)

    labelFrame.MouseLeave:Connect(function()
        TweenService:Create(labelFrame, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {BackgroundColor3 = library.selectedTheme.ItemFrame}):Play()
    end)
end
...
function tabtable:Select()
    ...
    task.spawn(function()
        for _,v in next, tabContainerScrolling:GetChildren() do
            if v.ClassName == "Frame" and v ~= tab then
                v.TabFrame.BackgroundColor3 = library.selectedTheme.TabFrame
                v.TabFrame.TabName.TextColor3 = library.selectedTheme.TabText
                ...
                -- v.TabFrame.UIStroke.Color = library.selectedTheme.TabUIStroke
    ...
    TweenService:Create(tabFrame, TweenInfo.new(.2, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {Size = UDim2.new(0, 122,0, 25)}):Play()
    TweenService:Create(tabName, TweenInfo.new(.2, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {Size = UDim2.new(0, 122,0, 25)}):Play()
    -- TweenService:Create(tabuIStroke, TweenInfo.new(.2, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {Color = library.selectedTheme.HighlightUIStroke}):Play()
    TweenService:Create(tabName, TweenInfo.new(.125, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {TextColor3 = library.selectedTheme.Highlight}):Play()
    TweenService:Create(tabFrame, TweenInfo.new(.125, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {BackgroundColor3 = library.selectedTheme.SelectedTabFrame}):Play()
end
